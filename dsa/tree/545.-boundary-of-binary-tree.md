...
A node is a boundary node if its:\
1\. a leaf node\
2\. left most ( traverse keeping left, if left doesn't exist go right ) Given its not leaf\
3\. right most ( traverse keeping right, if right doesn't exist go left ) Given its not leaf
